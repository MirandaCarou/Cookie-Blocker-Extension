...
- You may want to include screenshots and animated GIFs that help you demonstrate the steps or point out the part to which the suggestion is related. You can use this [tool](https://www.cockos.com/licecap/) to record GIFs on macOS and Windows, and this [tool](https://peek.molteni.io/) or [this tool](https://github.com/phw/peek) on Linux.
